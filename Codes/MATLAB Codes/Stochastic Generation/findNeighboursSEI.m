function NeighboursInd = findNeighboursSEI(Index,MatrixSize ,conn)
%% From: https://www.sciencedirect.com/science/article/pii/S0378775320313987#appsec2
% Modified from:
%%**************************************************************************
...
%%
NeighboursInd = [Index*(ones(size(NeighboursInd))) sort(NeighboursInd)] ; 
end
end